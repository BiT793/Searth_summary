namespace Searth_summary
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            reportDataSource1.Value = this.JobSeekerBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "Searth_summary.Summry.rdlc";
            ...
            // 
            this.JobSeekerBindingSource.DataSource = typeof(Searth_summary.ServiceReference1.JobSeeker);
            // 
            // Form1
            // 
